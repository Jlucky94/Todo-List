...
const PacksTable = () => {
    ...
    const packs = useAppSelector(state => state.packs.data.cardPacks)
                        ...
                        {rows.map((row) => (
                            ...
                            >
                                ...
                                <TableCell align="left">
                                    ...
                                    <Icon>
                                        <ModeEditIcon onClick={updatePackHandler({cardsPack:{_id:row.key,name:'newNamePack',grade:2,private:false}})}/>
                                    </Icon>
                                    <Icon>
